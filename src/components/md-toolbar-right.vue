<template>
    <div class="v-right-item">
        ...
        ></button>
        <!-- 只读 -->
        <button type="button" v-if="toolbars.readmodel" @click="$clicks('read')" class="op-icon fa fa-mavon-window-maximize" aria-hidden="true" :title="`${d_words.tl_read} (F11)`"></button>
        <!-- HTML -->
